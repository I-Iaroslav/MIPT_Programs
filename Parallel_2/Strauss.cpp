...
#define SIZE 2000 //размер матриц
#define BORDER 64 //с этого значения матрицы считаются обычным способом
...
//minus == false - сложение
//minus == true  - вычитание
...
//параллельное перемножение матриц, принимает на вход матрицу А,  матрицу В и нулевую матрицу C
...
//перемножение матриц Штрассена, принимает на вход матрицу А, матрицу В и нулевую матрицу C
